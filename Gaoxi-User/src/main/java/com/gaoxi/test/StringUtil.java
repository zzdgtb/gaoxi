...
*/
    ...
    /*public static String getFirstSpell(String chinese) {
        ...
        String firstWord = pybf.toString().substring(0, 1);
    ...
    public static boolean isJsonObject(String s) {
        ...
        if ((s.startsWith("{")) || (s.startsWith("[")) || ("true".equals(s)) || ("false".equals(s)) || ("null".equals(s))) {
            return true;
        }
        return isNumber(s);
    }
    ...
    public static Double toOxegen(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
        }
        return Double.valueOf(data) * 0.001;
    }

    public static Double toPm25(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
    ...
    public static Double toCo(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
        }
        return Double.valueOf(data) * 0.1;
    }

    public static Double toBenzene(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
    ...
    public static Double toRadon(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
    ...
    public static Double toFormaldehyde(String data) {
        if ("#NAN#".equals(data) || data == null) {
            return 0d;
        } else if (data.startsWith("#ERROR#")) {
            return 0d;
